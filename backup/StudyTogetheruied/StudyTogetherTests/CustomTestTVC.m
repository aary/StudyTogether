...
- (CustomCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    // REMOVE THIS COMMENT AND COMMENT THE NEXT LINE AND SEE WHAT HAPPENS
    CustomCell* cell = [self.tableView dequeueReusableCellWithIdentifier:@"cell"];
    //cell = [CustomCell cellWithButtonTitle:@"Whatever" andLabelString:@"LabelCrap"];
    ...
    [cell.customButton setTitle:@"Button" forState:UIControlStateNormal];
